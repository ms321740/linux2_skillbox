...
а. Доступ к "Wordpress" и "Drupal" осуществляется по вводу логина и пароля с редиректом, который отрабатывает по имени пользователя      Реквизиты будут указаны в конфце работы команды "vagrant up"
